...
/**
 * Interactive book all chapters viewed event.
 *
 * @package    mod_mubook
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class all_chapters_viewed extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed all chapters page of book with id '$this->objectid'";
    }

    #[\Override]
    public static function get_name() {
        return get_string('event_all_chapters_viewed', 'mod_mubook');
    }
