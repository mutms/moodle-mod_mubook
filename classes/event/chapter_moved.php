 ...
 */
final class chapter_moved extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' moved the chapter with id '$this->objectid'";
    }

    #[\Override]
    public static function get_name() {
        return get_string('event_chapter_moved', 'mod_mubook');
    }
