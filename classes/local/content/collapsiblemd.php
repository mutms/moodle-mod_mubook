...
/**
 * Collapsible content using Markdown text.
 *
 * @package    mod_mubook
 * @copyright  2025 Petr Skoda
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
final class collapsiblemd extends \mod_mubook\local\content {
    #[\Override]
    public function render(\renderer_base $output, toc $toc, int $firstheading): string {
        ...
        return '<div class="mubook-format-markdown">' . $output->render_from_template('mod_mubook/content/collapsible', $data) . '</div>';
    }
