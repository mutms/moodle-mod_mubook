...
$string['content_actions'] = 'Content actions';
...
$string['content_hidden'] = 'Hide content';
$string['content_sortorder'] = 'Position';
$string['content_text'] = 'Text';
$string['content_type_collapsible'] = 'Collapsible solution';
$string['content_type_collapsible_label_custom'] = 'Custom button';
$string['content_type_collapsible_label_default'] = 'Show solution';
$string['content_type_collapsiblemd'] = 'Collapsible solution (Markdown)';
$string['content_type_html'] = 'HTML text';
$string['content_type_markdown'] = 'Markdown text';
$string['content_type_unknown'] = 'Unknown type';
...
$string['content_unsafetrusted_confirmation'] = 'To prevent security issues enable only if HTML and all files are from a trusted source';
...
$string['markdown_flavor'] = 'Markdown flavour';
$string['markdown_flavor_commonmark'] = 'CommonMark';
$string['markdown_flavor_github'] = 'GitHub Flavored Markdown';
$string['markdown_html'] = 'HTML processing';
...
$string['page-mod-mubook-viewchapter'] = 'One book chapter page';
